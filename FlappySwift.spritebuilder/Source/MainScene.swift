...
//  FlappySwift
//
//  Created by Kevin Lee on 9/10/15.
...
class MainScene: GamePlayScene {
    ...
    override func didLoadFromCCB() {
        ...
        // spawn the first obstacles Part 7
        for i in 1...3 {
...
//        // move up and rotate part 9 modifcation
//        hero?.flap()
//        
...
//        sinceTouch = 0;
    ...
    func spawnNewObstacle() {
        ...
        //add to scene
        //_gamePhysicsNode.addChild(obstacle) part 7 did this
    ...
    func ccPhysicsCollisionBegin(pair: CCPhysicsCollisionPair!,hero: CCNode!,goal: CCNode!) -> Bool {
        ...
        score++
        _scoreLabel.string = String(score)
        return true
    }
}
